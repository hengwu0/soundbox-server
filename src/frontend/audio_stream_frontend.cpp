...
AudioStreamFrontend::AudioStreamFrontend(std::string input_file,
                                         std::string aec_socket_path)
    : input_file_(std::move(input_file)),
      aec_socket_path_(std::move(aec_socket_path)) {}

void AudioStreamFrontend::Run() {
  ...
  std::cout << "[frontend] finished: frames=" << frames_sent
